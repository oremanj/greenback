...
htmlhelp_basename = 'greenbackdoc'
...
latex_documents = [
    (master_doc, 'greenback.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'greenback', 'greenback Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'greenback', 'greenback Documentation',
     author, 'greenback', 'Reenter an async event loop from synchronous code',
     'Miscellaneous'),
]
